import { e as defineComponent, u as useData, f as useRoute, g as useRouter, h as onMounted, o as openBlock, c as createElementBlock } from "./app.763404e9.js";
...
function I() {
  for (var e2; I.__r = f.length; )
    e2 = f.sort(function(e3, t2) {
      ...
      e3.__d && (c2 = (o2 = (t2 = e3).__v).__e, (i2 = t2.__P) && (n2 = [], (r2 = _({}, o2)).__v = o2.__v + 1, q(i2, o2, r2, t2.__n, i2.ownerSVGElement !== void 0, o2.__h != null ? [c2] : null, n2, c2 == null ? w(o2) : c2, o2.__h), L(n2, o2), o2.__e != c2 && j(o2)));
    });
}
...
function q(e2, t2, n2, r2, o2, c2, i2, a2, u2) {
  ...
  try {
    e:
      if (typeof w2 == "function") {
        ...
        f2.context = g2, f2.props = y2, f2.state = f2.__s, (l2 = s.__r) && l2(t2), f2.__d = false, f2.__v = t2, f2.__P = e2, l2 = f2.render(f2.props, f2.state, f2.context), f2.state = f2.__s, f2.getChildContext != null && (r2 = _(_({}, r2), f2.getChildContext())), p2 || f2.getSnapshotBeforeUpdate == null || (h2 = f2.getSnapshotBeforeUpdate(m2, d2)), O2 = l2 != null && l2.type === S && l2.key == null ? l2.props.children : l2, D(e2, Array.isArray(O2) ? O2 : [O2], t2, n2, r2, o2, c2, i2, a2, u2), f2.base = t2.__e, t2.__h = null, f2.__h.length && i2.push(f2), v2 && (f2.__E = f2.__ = null), f2.__e = false;
      } else
...
function M(e2, t2, n2, r2, o2, c2, i2, a2) {
  ...
  if (d2 === null)
    ...
    if (function(e3, t3, n3, r3, o3) {
      ...
      t2.__k = [];
    else if (y2 = t2.props.children, D(e2, Array.isArray(y2) ? y2 : [y2], t2, n2, r2, o2 && d2 !== "foreignObject", c2, i2, e2.firstChild, a2), c2 != null)
      for (y2 = c2.length; y2--; )
        c2[y2] != null && b(c2[y2]);
...
function B(e2, t2, n2) {
  var r2, o2, c2;
  s.__ && s.__(e2, t2), o2 = (r2 = typeof n2 == "function") ? null : n2 && n2.__k || t2.__k, c2 = [], q(t2, e2 = (!r2 && n2 || t2).__k = g(S, null, [e2]), o2 || h, h, t2.ownerSVGElement !== void 0, !r2 && n2 ? [n2] : o2 ? null : t2.firstChild ? v.slice.call(t2.childNodes) : null, c2, !r2 && n2 ? n2 : o2 ? o2.__e : t2.firstChild, r2), L(c2, e2);
}
function V(e2, t2) {
  B(e2, t2, V);
}
...
var Pe = typeof Symbol != "undefined" && Symbol.for && Symbol.for("react.element") || 60103, Ie = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|fill|flood|font|glyph(?!R)|horiz|marker(?!H|W|U)|overline|paint|stop|strikethrough|stroke|text(?!L)|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/, De = function(e2) {
...
s.vnode = function(e2) {
  ...
  t2 && n2.class != n2.className && (Te.enumerable = "className" in n2, n2.className != null && (r2.class = n2.className), Object.defineProperty(r2, "className", Te)), e2.$$typeof = Pe, qe && qe(e2);
};
var Le = s.__r;
s.__r = function(e2) {
  Le && Le(e2), Re = e2.__c;
...
}, version: "16.8.0", Children: ye, render: ke, hydrate: function(e2, t2, n2) {
...
function Ht(e2) {
  var t2 = e2.reduce(function(e3, t3) {
    ...
    var n2 = t3.searchClient, r2 = t3.execute, o2 = t3.requests, c2 = e3.find(function(e4) {
      return Lt(t3) && Lt(e4) && e4.searchClient === n2 && e4.execute === r2;
    });
    if (c2) {
      var i2;
    ...
    return Promise.all(e3.map(function(e4) {
      ...
      return function(e5) {
        var t3 = e5.collections, n3 = e5.props, r3 = e5.state, o3 = t3.reduce(function(e6, t4) {
          return kt(kt({}, e6), {}, Ct({}, t4.source.sourceId, kt(kt({}, t4.source), {}, { getItems: function() {
            return Ge(t4.items);
          } })));
        }, {});
...
function kn(e2) {
  var t2 = e2.translations, n2 = t2 === void 0 ? {} : t2, r2 = n2.selectText, o2 = r2 === void 0 ? "to select" : r2, c2 = n2.navigateText, i2 = c2 === void 0 ? "to navigate" : c2, a2 = n2.closeText, u2 = a2 === void 0 ? "to close" : a2, l2 = n2.searchByText, s2 = l2 === void 0 ? "Search by" : l2;
  return Ue.createElement(Ue.Fragment, null, Ue.createElement("div", { className: "DocSearch-Logo" }, Ue.createElement(In, { translations: { searchByText: s2 } })), Ue.createElement("ul", { className: "DocSearch-Commands" }, Ue.createElement("li", null, Ue.createElement("span", { className: "DocSearch-Commands-Key" }, Ue.createElement(Dn, null, Ue.createElement("path", { d: "M12 3.53088v3c0 1-1 2-2 2H4M7 11.53088l-3-3 3-3" }))), Ue.createElement("span", { className: "DocSearch-Label" }, o2)), Ue.createElement("li", null, Ue.createElement("span", { className: "DocSearch-Commands-Key" }, Ue.createElement(Dn, null, Ue.createElement("path", { d: "M7.5 3.5v8M10.5 8.5l-3 3-3-3" }))), Ue.createElement("span", { className: "DocSearch-Commands-Key" }, Ue.createElement(Dn, null, Ue.createElement("path", { d: "M7.5 11.5v-8M10.5 6.5l-3-3-3 3" }))), Ue.createElement("span", { className: "DocSearch-Label" }, i2)), Ue.createElement("li", null, Ue.createElement("span", { className: "DocSearch-Commands-Key" }, Ue.createElement(Dn, null, Ue.createElement("path", { d: "M13.6167 8.936c-.1065.3583-.6883.962-1.4875.962-.7993 0-1.653-.9165-1.653-2.1258v-.5678c0-1.2548.7896-2.1016 1.653-2.1016.8634 0 1.3601.4778 1.4875 1.0724M9 6c-.1352-.4735-.7506-.9219-1.46-.8972-.7092.0246-1.344.57-1.344 1.2166s.4198.8812 1.3445.9805C8.465 7.3992 8.968 7.9337 9 8.5c.032.5663-.454 1.398-1.4595 1.398C6.6593 9.898 6 9 5.963 8.4851m-1.4748.5368c-.2635.5941-.8099.876-1.5443.876s-1.7073-.6248-1.7073-2.204v-.4603c0-1.0416.721-2.131 1.7073-2.131.9864 0 1.6425 1.031 1.5443 2.2492h-2.956" }))), Ue.createElement("span", { className: "DocSearch-Label" }, u2))));
}
function Cn(e2) {
...
var Lr = { WithinQueryParameters: 0, WithinHeaders: 1 };
function Mr(e2, t2) {
...
var eo = function(e2) {
  var n2 = e2.appId, r2 = function(e3, t2, n3) {
    ...
    return { headers: function() {
      return e3 === Lr.WithinHeaders ? r3 : {};
    }, queryParameters: function() {
      return e3 === Lr.WithinQueryParameters ? r3 : {};
    } };
  }(e2.authMode !== void 0 ? e2.authMode : Lr.WithinHeaders, n2, e2.apiKey), o2 = function(e3) {
  ...
  return function(t2, n2, r2) {
    return e2.transporter.read({ method: Kr, path: qr("1/answers/%s/prediction", e2.indexName), data: { query: t2, queryLanguages: n2 }, cacheable: true }, r2);
  };
}, co = function(e2) {
  return function(t2, n2) {
    return e2.transporter.read({ method: Kr, path: qr("1/indexes/%s/query", e2.indexName), data: { query: t2 }, cacheable: true }, n2);
  };
}, io = function(e2) {
  return function(t2, n2, r2) {
    return e2.transporter.read({ method: Kr, path: qr("1/indexes/%s/facets/%s/query", e2.indexName, t2), data: { facetQuery: n2 }, cacheable: true }, r2);
  };
}, ao = 1, uo = 2, lo = 3;
function so(e2, n2, r2) {
  ...
  } }), responsesCache: Nr(), requestsCache: Nr({ serializable: false }), hostsCache: xr({ caches: [Ar({ key: "".concat("4.8.5", "-").concat(e2) }), Nr()] }), userAgent: Qr("4.8.5").add({ segment: "Browser", version: "lite" }), authMode: Lr.WithinQueryParameters };
...
function go(e2) {
  var t2 = e2.appId, n2 = t2 === void 0 ? "BH4D9OD16A" : t2, r2 = e2.apiKey, o2 = e2.indexName, c2 = e2.placeholder, i2 = c2 === void 0 ? "Search docs" : c2, a2 = e2.searchParameters, u2 = e2.onClose, l2 = u2 === void 0 ? ur : u2, s2 = e2.transformItems, f2 = s2 === void 0 ? ar : s2, p2 = e2.hitComponent, m2 = p2 === void 0 ? Cn : p2, d2 = e2.resultsFooterComponent, h2 = d2 === void 0 ? function() {
    return null;
  } : d2, v2 = e2.navigator, y2 = e2.initialScrollY, _2 = y2 === void 0 ? 0 : y2, b2 = e2.transformSearchClient, g2 = b2 === void 0 ? ar : b2, O2 = e2.disableUserPersonalization, S2 = O2 !== void 0 && O2, E2 = e2.initialQuery, w2 = E2 === void 0 ? "" : E2, j2 = e2.translations, P2 = j2 === void 0 ? {} : j2, I2 = e2.getMissingResultsUrl, D2 = P2.footer, k2 = P2.searchBox, C2 = bo(P2, fo), A2 = yo(Ue.useState({ query: "", collections: [], completion: null, context: {}, isOpen: false, activeItemId: null, status: "idle" }), 2), x2 = A2[0], N2 = A2[1], R2 = Ue.useRef(null), T2 = Ue.useRef(null), q2 = Ue.useRef(null), L2 = Ue.useRef(null), M2 = Ue.useRef(null), H2 = Ue.useRef(10), U2 = Ue.useRef(typeof window != "undefined" ? window.getSelection().toString().slice(0, 64) : "").current, F2 = Ue.useRef(w2 || U2).current, B2 = function(e3, t3, n3) {
    return Ue.useMemo(function() {
      var r3 = so(e3, t3);
      return r3.addAlgoliaAgent("docsearch", "3.0.0-alpha.50"), /docsearch.js \(.*\)/.test(r3.transporter.userAgent.value) === false && r3.addAlgoliaAgent("docsearch-react", "3.0.0-alpha.50"), n3(r3);
    }, [e3, t3, n3]);
  }(n2, r2, g2), V2 = Ue.useRef(kr({ key: "__DOCSEARCH_FAVORITE_SEARCHES__".concat(o2), limit: 10 })).current, z2 = Ue.useRef(kr({ key: "__DOCSEARCH_RECENT_SEARCHES__".concat(o2), limit: V2.getAll().length === 0 ? 7 : 4 })).current, W2 = Ue.useCallback(function(e3) {
    if (!S2) {
      var t3 = e3.type === "content" ? e3.__docsearch_parent : e3;
      t3 && V2.getAll().findIndex(function(e4) {
        return e4.objectID === t3.objectID;
      }) === -1 && z2.add(t3);
    }
  }, [V2, z2, S2]), K2 = Ue.useMemo(function() {
    return Pn({ id: "docsearch", defaultActiveItemId: 0, placeholder: i2, openOnFocus: true, initialState: { query: F2, context: { searchSuggestions: [] } }, navigator: v2, onStateChange: function(e3) {
      N2(e3.state);
    }, getSources: function(e3) {
      var t3 = e3.query, n3 = e3.state, r3 = e3.setContext, c3 = e3.setStatus;
      return t3 ? B2.search([{ query: t3, indexName: o2, params: ho({ attributesToRetrieve: ["hierarchy.lvl0", "hierarchy.lvl1", "hierarchy.lvl2", "hierarchy.lvl3", "hierarchy.lvl4", "hierarchy.lvl5", "hierarchy.lvl6", "content", "type", "url"], attributesToSnippet: ["hierarchy.lvl1:".concat(H2.current), "hierarchy.lvl2:".concat(H2.current), "hierarchy.lvl3:".concat(H2.current), "hierarchy.lvl4:".concat(H2.current), "hierarchy.lvl5:".concat(H2.current), "hierarchy.lvl6:".concat(H2.current), "content:".concat(H2.current)], snippetEllipsisText: "\u2026", highlightPreTag: "<mark>", highlightPostTag: "</mark>", hitsPerPage: 20 }, a2) }]).catch(function(e4) {
        throw e4.name === "RetryError" && c3("error"), e4;
      }).then(function(e4) {
        var t4 = e4.results[0], o3 = t4.hits, c4 = t4.nbHits, i3 = ir(o3, function(e5) {
          return fr(e5);
        });
        return n3.context.searchSuggestions.length < Object.keys(i3).length && r3({ searchSuggestions: Object.keys(i3) }), r3({ nbHits: c4 }), Object.values(i3).map(function(e5, t5) {
          return { sourceId: "hits".concat(t5), onSelect: function(e6) {
            ...
            W2(t6), n4.shiftKey || n4.ctrlKey || n4.metaKey || l2();
        ...
        W2(t4), n4.shiftKey || n4.ctrlKey || n4.metaKey || l2();
  ...
  }, [o2, a2, B2, l2, z2, V2, W2, F2, i2, v2, f2, S2]), J2 = K2.getEnvironmentProps, $2 = K2.getRootProps, Q2 = K2.refresh;
  return function(e3) {
  ...
  }({ getEnvironmentProps: J2, panelElement: L2.current, formElement: q2.current, inputElement: M2.current }), function(e3) {
    var t3 = e3.container;
    Ue.useEffect(function() {
      if (t3) {
  ...
  }({ container: R2.current }), Ue.useEffect(function() {
    return document.body.classList.add("DocSearch--active"), function() {
      var e3, t3;
      document.body.classList.remove("DocSearch--active"), (e3 = (t3 = window).scrollTo) === null || e3 === void 0 || e3.call(t3, 0, _2);
    };
  }, []), Ue.useEffect(function() {
    window.matchMedia("(max-width: 750px)").matches && (H2.current = 5);
  }, []), Ue.useEffect(function() {
    L2.current && (L2.current.scrollTop = 0);
  }, [x2.query]), Ue.useEffect(function() {
    F2.length > 0 && (Q2(), M2.current && M2.current.focus());
  }, [F2, Q2]), Ue.useEffect(function() {
    function e3() {
      if (T2.current) {
  ...
  }, []), Ue.createElement("div", po({ ref: R2 }, $2({ "aria-expanded": true }), { className: ["DocSearch", "DocSearch-Container", x2.status === "stalled" && "DocSearch-Container--Stalled", x2.status === "error" && "DocSearch-Container--Errored"].filter(Boolean).join(" "), role: "button", tabIndex: 0, onMouseDown: function(e3) {
    e3.target === e3.currentTarget && l2();
  } }), Ue.createElement("div", { className: "DocSearch-Modal", ref: T2 }, Ue.createElement("header", { className: "DocSearch-SearchBar", ref: q2 }, Ue.createElement(jr, po({}, K2, { state: x2, autoFocus: F2.length === 0, inputRef: M2, isFromSelection: Boolean(F2) && F2 === U2, translations: k2, onClose: l2 }))), Ue.createElement("div", { className: "DocSearch-Dropdown", ref: L2 }, Ue.createElement(Or, po({}, K2, { indexName: o2, state: x2, hitComponent: m2, resultsFooterComponent: h2, disableUserPersonalization: S2, recentSearches: z2, favoriteSearches: V2, inputRef: M2, translations: C2, getMissingResultsUrl: I2, onItemClick: function(e3) {
    W2(e3), l2();
  } }))), Ue.createElement("footer", { className: "DocSearch-Footer" }, Ue.createElement(kn, { translations: D2 }))));
}
function Oo() {
...
function jo(e2) {
  ke(Ue.createElement(wo, o({}, e2, { transformSearchClient: function(t2) {
    return t2.addAlgoliaAgent("docsearch.js", "3.0.0-alpha.50"), e2.transformSearchClient ? e2.transformSearchClient(t2) : t2;
  } })), function(e3) {
